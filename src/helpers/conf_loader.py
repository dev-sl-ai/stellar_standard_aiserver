...
SHOW_MAP_TIMEOUT = server_config.get("show_map_timeout", 30)
SESSION_TIMEOUT = server_config.get("session_timeout", 60)
RAG_TTS_TIMEOUT = server_config.get("rag_tts_timeout", 180)
TRANSLATION_CACHE_FILE = server_config.get("translation_cache_file", "cache/translation_cache.json")
